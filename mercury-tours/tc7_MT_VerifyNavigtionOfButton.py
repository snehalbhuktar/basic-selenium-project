#Verify navigation of 'Back to Home' button on 'Flight confirmation' page
...
class VerifyNavigationTest(unittest.TestCase):
    ...
    def test_verify_navigation1(self):
        ...
        if browser.title == 'Flight Confirmation: Mercury Tours':
            #Click on 'Back to Home' button and verify the navigation to the Home page
            browser.find_element_by_xpath(' //td//td//td//td[2]//a[1]//img[1]').click()
