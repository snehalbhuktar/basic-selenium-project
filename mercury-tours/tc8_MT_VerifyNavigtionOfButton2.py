#Verify navigation of 'Back to Flights' button on 'Flight confirmation' page
...
class VerifyNavigation2Test(unittest.TestCase):
    ...
    def test_verify_navigation2(self):
        ...
        if browser.title == 'Flight Confirmation: Mercury Tours':
            #Click on 'Back to Flights' button and verify the navigation to Find a Flight page
            browser.find_element_by_xpath(' //td//td//td//td//td[1]//a[1]//img[1]').click()
